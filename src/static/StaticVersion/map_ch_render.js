;(function (root, factory) {
    if (typeof exports === 'object' && typeof exports.nodeName !== 'string') {
        // CommonJS
        exports = module.exports = factory(require('echarts'), require('./geocoord_collection').chinaGeo, require('./china.js'));
    } else {
        // Browser globals
        root.map_ch_render = factory(root.echarts, root.geocoord_collection.chinaGeo, root.world);
    }
})(this, function (echarts, chinaGeo, chinajs) {
