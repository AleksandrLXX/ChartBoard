;(function (root, factory) {
	...
	if (typeof define === 'function' && define.amd) {
		define('geocoord_collection', factory)
	} else if (typeof exports === 'object') {
		exports = module.exports = factory()
	} else {
		// @deprecated
		root.geocoord_collection = factory()
	}
})(this, function () {
	'use strict'
	var chinaGeo = [{
	...
	const provinces = ["台湾", "河北", "山西", "内蒙古", "辽宁", "吉林", "黑龙江", "江苏", "浙江", "安徽", "福建", "江西", "山东", "河南", "湖北", "湖南", "广东", "广西", "海南", "四川", "贵州", "云南", "西藏", "陕西", "甘肃", "青海", "宁夏", "新疆", "北京", "天津", "上海", "重庆", "香港", "澳门"]
