;(function (root, factory) {
    if (typeof exports === 'object' && typeof exports.nodeName !== 'string') {
        // CommonJS
        exports = module.exports = factory(require('echarts'), require('./geocoord_collection').worldGeo, require('./world.js'));
    } else {
        // Browser globals
        root.map_world_render = factory(root.echarts, root.geocoord_collection.worldGeo,root.world);
    }
})(this, function (echarts, worldGeo,world) {
    var groupColors = [
